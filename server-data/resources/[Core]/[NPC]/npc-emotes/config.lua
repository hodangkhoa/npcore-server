        ...
        data = {                                    -- Data that is passed to Javascript
            ...
            style = {                               -- Wheel style settings
                ...
                slices = {                          -- Slice style settings
                    ...
                    hover = { ['fill'] = '#006aff', ['stroke'] = '#000000', ['stroke-width'] = 2, ['opacity'] = 0.80 },
                    selected = { ['fill'] = '#006aff', ['stroke'] = '#000000', ['stroke-width'] = 2, ['opacity'] = 0.80 }
                },
            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    labels = {"GO OUT", "COUGH", "WHISTLE", "THROAT", "MIDDLE FINGER", "FACE PALM"},
                    commands = {"", "e cough", "e whistle2", "e cutthroat2", "e finger", "e facepalm4"}
                },
                {
                    navAngle = 285,                 -- Oritentation of wheel
                    minRadiusPercent = 0.6,         -- Minimum radius of wheel in percentage
                    maxRadiusPercent = 0.9,         -- Maximum radius of wheel in percentage
                    labels = {"CIGARETTE", "FEAR", "SURRENDER", "WOUNDED", "EXTENDED", "EXTENDED2", "CHAIR2", "CHAIR1", "WALL", "HARD", "FOLDER", "NOTEBOOK"},
                    commands = {"e smoke2", "e scared2", "e surrender", "e shot", "e sunbatheback", "e prone", "e sitchair3", "e sitchair", "e lean", "e cop", "e clipboard2", "e notepad2"}
                }
            }
        }
    }
...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://cdn.discordapp.com/attachments/860905633783480330/867899923588448276/NPC_Emotes_Banner.png",
